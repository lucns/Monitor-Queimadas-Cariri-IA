...
#DATA_PATH = "C:" + DESKTOP_PATH.replace("\\", "/") + "/WeatherData"
DATA_PATH = os. getcwd() + "/WeatherData"
...
CITIES_COORDINATES = {
    ...
    'Barbalha': '-7.288738,-39.299320', 'Jardim': '-7.586031,-39.279563', 'Porteiras': '-7.534501,-39.116856',
    'Penaforte': '-7.830278,-39.072340', 'Jati': '-7.688990,-39.005227', 'Brejo Santo': '-7.488500,-38.987459',
    'Abaiara': '-7.349389,-39.033383', 'Milagres': '-7.310940,-38.938627', 'Mauriti': '-7.382958,-38.771900',
    'Barro': '-7.174146,-38.779534', 'Caririaçu': '-7.042127,-39.285435', 'Granjeiro': '-6.887292,-39.220469',
    'Aurora': '-6.943031,-38.969761', 'Lavras da Mangabeira': '-6.752719,-38.965939', 'Ipaumirim': '-6.789527,-38.718022',
    'Baixio': '-6.730631,-38.716898', 'Umari': '-6.644247,-38.699599'
}
...
def main():    
    UPDATE_TIME = 15 # time between verifications
    print(DATA_PATH)
